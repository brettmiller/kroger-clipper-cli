...
can be pasted straight back. It also lists Special savings, which has no filter
of its own yet. "General" is one of Kroger's real departments, not a stand-in for
a missing value.
